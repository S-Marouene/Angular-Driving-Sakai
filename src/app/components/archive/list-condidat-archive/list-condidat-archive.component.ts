...
@Component({
  selector: 'app-list-condidat-archive',
  templateUrl: './list-condidat-archive.component.html',
  styleUrls: ['./list-condidat-archive.component.css']
})
export class ListCondidatArchiveComponent implements OnInit {

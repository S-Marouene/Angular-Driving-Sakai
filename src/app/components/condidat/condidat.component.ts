...
export class CondidatComponent implements OnInit {
    ...
    public pieces: any = ['Photos', 'Certificat médical', 'Quittance Paiement', 'CIN'];
    valExamen: string;
    ...
    constructor(private customerService: CustomerService,
        ...
        public fb: FormBuilder, private toastr: ToastrService,public datepipe: DatePipe){
        }

    ngOnInit() {
        this.selected_t_c_code=true;
        this.selected_t_c_cond=true;
        this.refreshListCondidats()
    ...
    onSubmit() {
        ...
        formData.append('date_naiss',this.datepipe.transform(this.form_condidat.value.date_naiss, 'yyyy-MM-dd'));
        ...
        formData.append('prix_frf_code',this.form_condidat.value.prix_forfaitaire_code) ;
        formData.append('prix_hr_cond',this.form_condidat.value.prix_h_cond);
        formData.append('prix_frf_cond',this.form_condidat.value.prix_forfaitaire_cond);
        formData.append('hist_av_date',this.datepipe.transform(this.form_condidat.value.hist_av_date, 'yyyy-MM-dd'));
        formData.append('hist_montant_paye',this.form_condidat.value.hist_montant_paye);
        formData.append('hist_nb_hr_code',this.form_condidat.value.hist_nb_hr_code);
        formData.append('hist_nb_hr_cond',this.form_condidat.value.hist_nb_hr_cond);
        formData.append('hist_nb_reinsc_cond',this.form_condidat.value.hist_nb_reinsc_cond);
        formData.append('hist_caisse',this.form_condidat.value.hist_caisse);
        formData.append('hist_nb_exam_code',this.form_condidat.value.hist_nb_exam_code);
        formData.append('hist_nb_exam_cond',this.form_condidat.value.hist_nb_exam_cond);
        formData.append('hist_nb_reinsc_code',this.form_condidat.value.hist_nb_reinsc_code);
        formData.append('hist_nb_droit_exam',this.form_condidat.value.hist_nb_droit_exam);
